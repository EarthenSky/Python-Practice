...
def check_conv_type ():
    ...
    while True:
         try:
             ...
             print "" #makes a new line (looks better)
         ...
         except ValueError: #called when string attempted to be turned to integer
...
def check_temp_val ():
    ...
    while True:
         try:
             ...
             break  #stop running code after this
         except ValueError: #called when string attempted to be turned to float
             print "\nOops!  That was no valid number.  Try again...\n"

#creates a custom temp
#if user enters invalid value, it will do nothing and go back to the beginning of the program
def make_custom_temp ():
    ...
    new_equation = new_equation.replace("import", "")   #stops libraries from being imported
...
while True:
    ...
    #checks if user wants to create new equation
    if temp_type == 0:
        make_custom_temp()
    else:
